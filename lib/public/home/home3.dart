          ...
          children: [
            Row(
              ...
              children: [
                ...
                _container(context, screenSize,Color.fromARGB(255, 241, 23, 42),
                    'assets/images/eksad IT resources.jpg','Talenta ProTalent', row3,
                    PostBody(Image: 'assets/images/eksad IT resources.jpg',
                        HeadText: headgrid6, Tanggal: tanggal, Bodyfull: bodyfull6, Urutan: urutan6)),
              ],
            ),
            TextButton.icon(
