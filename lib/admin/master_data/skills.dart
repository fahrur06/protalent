...
class Skills {
  Skills(this.no, this.skills, this.posting, this.status, this.delete);
...
class _SkillState extends State<Skill> {
  String skill = '';
  EasyTableModel<Skills>? _model;
  @override
  void initState() {
    super.initState();

    List<Skills> rows = [
      Skills(1, 'Head Product', '2022-07-18', 'ACTIVE',
          TextButton(onPressed: () {}, child: const Text('delete'))),
      Skills(2, 'Java Developer', '2022-01-01', 'ACTIVE',
          TextButton(onPressed: () {}, child: const Text('delete'))),
      Skills(3, '', '', '',
          TextButton(onPressed: () {}, child: const Text('delete'))),
      Skills(4, '', '', '',
    ...
    _model = EasyTableModel<Skills>(rows: rows, columns: [
      EasyTableColumn(
          name: 'No',
          ...
          intValue: (row) => row.no),
      EasyTableColumn(
          name: 'Skill', weight: 3, stringValue: (row) => row.skills),
      EasyTableColumn(
          name: 'Posted',
          headerAlignment: Alignment.center,
          cellAlignment: Alignment.center,
  ...
  Widget build(BuildContext context) {
    Future openDialog() => showDialog(
          context: context,
          builder: (context) => EasyTable<Skills>(
            _model,
            columnsFit: true,
          ),
          //     TextFormField(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        onPressed: () async {
                          final skill = await openDialog();
                          if (skill == null || skill.isEmpty) return;
                          setState(() => this._model = skill);
                        },
                        child: Container(
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    switch (_sortColumnIndex.value) {
      case 0:
        ...
        break;
      case 1:
        _dessertsDataSource.sort<String>((d) => d.skill, _sortAscending.value);
        break;
      case 2:
          ...
          PaginatedDataTable(
            ...
            columns: [
              ...
              DataColumn(
                ...
                onSort: (columnIndex, ascending) =>
                    sort<String>((d) => d.skill, columnIndex, ascending),
              ),
              DataColumn(
