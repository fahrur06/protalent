...
class Tingkatan {
  Tingkatan(this.no, this.level, this.posting, this.status, this.delete);
...
class _LevelState extends State<Level> {
  String level='';
  EasyTableModel<Tingkatan>? _model;
  ...
  void initState() {
    ...
    List<Tingkatan> rows = [
      Tingkatan(1, 'Head Product', '2022-07-18', 'ACTIVE', TextButton(onPressed: (){}, child: Text('delete'))),
      Tingkatan(2, 'Java Developer', '2022-01-01', 'ACTIVE', TextButton(onPressed: (){}, child: Text('delete'))),
      Tingkatan(3, '', '', '', TextButton(onPressed: (){}, child: Text('delete'))),
      Tingkatan(4, '', '', '', TextButton(onPressed: (){}, child: Text('delete'))),
      Tingkatan(5, '', '', '', TextButton(onPressed: (){}, child: Text('delete'))),
      Tingkatan(6, '', '', '', TextButton(onPressed: (){}, child: Text('delete'))),


    ];

    _model = EasyTableModel<Tingkatan>(rows: rows, columns: [
  ...
  Widget build(BuildContext context) {
    Future openDialog() => showDialog(context: context, builder: (context) => EasyTable<Tingkatan>(_model,columnsFit: true,),
      //     TextFormField(
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    switch (_sortColumnIndex.value) {
      case 0:
        ...
        break;
      case 1:
        _dessertsDataSource.sort<String>((d) => d.level, _sortAscending.value);
        break;
      case 2:
          ...
          PaginatedDataTable(
            ...
            columns: [
              ...
              DataColumn(
                ...
                onSort: (columnIndex, ascending) =>
                    sort<String>((d) => d.level, columnIndex, ascending),
              ),
              DataColumn(
