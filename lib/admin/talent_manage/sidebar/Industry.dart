...
class EditIndustry extends StatefulWidget {
  const EditIndustry({Key? key}) : super(key: key);

  @override
  State<EditIndustry> createState() => _EditIndustryState();
}
...
class _EditIndustryState extends State<EditIndustry> {
  ...
  void initState() {
    ...
    List<_industry> rows = [
      _industry(1, 'Product Management', '2022-07-18', 'ACTIVE',
          TextButton(onPressed: () {}, child: Text('delete'))),
      _industry(2, 'Marketing and Communication ', '2022-01-01', 'ACTIVE',
          TextButton(onPressed: () {}, child: Text('delete'))),
      _industry(3, 'Data Science', '2022-03-29', 'ACTIVE',
          TextButton(onPressed: () {}, child: Text('delete'))),
      _industry(
    ...
    _model = EasyTableModel<_industry>(rows: rows, columns: [
      EasyTableColumn(
          ...
          intValue: (row) => row.no),
      EasyTableColumn(
          name: 'Industry', weight: 3, stringValue: (row) => row.industry),
      EasyTableColumn(
          name: 'Posted',
          headerAlignment: Alignment.center,
          cellAlignment: Alignment.center,
